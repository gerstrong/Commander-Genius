...
#include "Debug.h"
#include <base/interface/Mutex.h>
#include <base/interface/Iterator.h>
#include <base/interface/RefCounter.h>
#include "Event.h"
...
int CreateRecDir(const std::string& abs_filename, bool last_is_dir = true);
