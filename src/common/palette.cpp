...
void pal_init()
{
	configPalette(0, 0, 0x00,0x00,0x00);
	configPalette(1, 0, 0x00,0x00,0xa8);
	configPalette(2, 0, 0x00,0xa8,0x00);
	configPalette(3, 0, 0x00,0xa8,0xa8);
	configPalette(4, 0, 0xa8,0x00,0x00);
	configPalette(5, 0, 0xa8,0x00,0xa8);
	configPalette(6, 0, 0xa8,0x54,0x00);
	configPalette(7, 0, 0xa8,0xa8,0xa8);
	configPalette(8, 0, 0x54,0x54,0x54);
	configPalette(9, 0, 0x54,0x54,0xfc);
	configPalette(10, 0, 0x54,0xfc,0x54);
	configPalette(11, 0, 0x54,0xfc,0xfc);
	configPalette(12, 0, 0xfc,0x54,0x54);
	configPalette(13, 0, 0xfc,0x54,0xfc);
	...
	configPalette(4, 1, 0x00,0x00,0x00);
	configPalette(5, 1, 0x00,0x00,0x00);
	configPalette(6, 1, 0x00,0x00,0x00);
	configPalette(7, 1, 0x54,0x54,0x54);
	configPalette(8, 1, 0x00,0x00,0x00);
	configPalette(9, 1, 0x00,0x00,0xa8);
	configPalette(10, 1, 0x00,0xa8,0x00);
	configPalette(11, 1, 0x00,0xa8,0xa8);
	configPalette(12, 1, 0xa8,0x00,0x00);
	configPalette(13, 1, 0xa8,0x00,0xa8);
	configPalette(14, 1, 0xa8,0x54,0x00);
	configPalette(15, 1, 0xa8,0xa8,0xa8);
