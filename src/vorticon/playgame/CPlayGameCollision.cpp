...
//    	p_player->blockedu = true;
//    else if( p_player->goto_y >= ((m_Map.m_height)<<CSF) ) // lower edge or floor
//    {
//    	p_player->blockedd = true;
//    	p_player->kill(true);
//    }
//
//    if( (p_player->goto_x) >= ((m_Map.m_width-3)<<CSF) ) // right edge
//    	p_player->blockedr = true;
...
//
//	int x=p_player->getXRightPos();
//	int y1=p_player->getXLeftPos()+1;
//	int y2=p_player->getYMidPos();
//	int y3=p_player->getYDownPos()+(1<<STC)-1;
//
//	int t1 = m_Map.at(x>>CSF, y1>>CSF);
//	int t2 = m_Map.at(x>>CSF, y2>>CSF);
//	int t3 = m_Map.at(x>>CSF, y3>>CSF);
//
...
//	int t1 = m_Map.at(x1>>CSF, y>>CSF);
//	int t2 = m_Map.at(x2>>CSF, y>>CSF);
//
//	if(p_player->pdie) return false;
//
...
//{
//	CSprite &sprite = g_pGfxEngine->getSprite(player.sprite);
