...
mTimer(0)
{
  	...
  	mActionMap[A_AMPTON_TURN] = (void (CStunnable::*)()) &CAmpton::processWalking;
  	mActionMap[A_AMPTON_START_POLE] = (void (CStunnable::*)()) &CAmpton::processWalking;
  	mActionMap[A_AMPTON_POLE_SLIDE] = (void (CStunnable::*)()) &CAmpton::processWalking;
  	mActionMap[A_AMPTON_STOP_POLE] = (void (CStunnable::*)()) &CAmpton::processWalking;
  	mActionMap[A_AMPTON_FLIP_SWITCH] = (void (CStunnable::*)()) &CAmpton::processWalking;
