...
<div id= "contentHeader">
    <img src= "/img/toplogo.jpg" height= "87" width= "342" id= "contentHeaderImg" alt= "The Bean-With-Bacon" />
    <ul>
        <li><a href= "/" id= "indexLink" title= "Find out about us. (You know you want to.)">
                <img src= "/img/buttonAbout.jpg" height= "40" width= "120" alt= "About Us" />
                About Us</a></li>
        <li><a href= "/news/" id= "newsLink" title= "Have you heard what's new?">
                <img src= "/img/buttonNews.jpg" height= "40" width= "120" alt= "News" />
                News</a></li>
        <li><a href= "/download/" id= "downLink" title= "Get this fantastic interpreter.">
        ...
        <li><a href= "/doc/html/index.html" id= "docLink" title= "Delve into our documentation.">
                ...
                Documentation</a></li>
        <li><a href= "/compat/" id= "compatLink" title= "View the compatability chart.">
                <img src= "/img/buttonCompat.jpg" height= "40" width= "120" alt= "Compatability Chart" />
                Compatability Chart</a></li>
        <li><a href= "/screens/" id= "scrLink" title= "Checkout some screenshots of our project.">
                <img src= "/img/buttonScr.jpg" height= "40" width= "120" alt= "Screenshots" />
                Screenshots</a></li>
        <li><a href= "/videos/" id= "vidLink" title= "Drool over our spiffy videos.">
                <img src= "/img/buttonVid.jpg" height= "40" width= "120" alt= "Videos" />
                Videos</a></li>
        <li><a href= "/links/" id= "linksLink" title= "See what else we think is cool.">
